...
java -Xms$MIN_HEAP -Xmx$MAX_HEAP -Djava.net.preferIPv4Stack=true -Dhazelcast.config=/opt/hazelcast/hazelcast-conf.xml -cp "/opt/hazelcast/hazelcast-3.5-EA.jar:/opt/hazelcast/" Start
